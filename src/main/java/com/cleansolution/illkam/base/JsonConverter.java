...
public class JsonConverter implements AttributeConverter<List<Map<String, Object>>, String> {
    ...
    public String convertToDatabaseColumn(List<Map<String, Object>> attribute) {
        try {
            ...
            throw new IllegalArgumentException("Error converting List<Map<String, Object>> to JSON string.", e);
        }
    }
    ...
    public List<Map<String, Object>> convertToEntityAttribute(String dbData) {
        try {
            ...
            throw new IllegalArgumentException("Error reading JSON string to List<Map<String, Object>>.", e);
        }
    }
}